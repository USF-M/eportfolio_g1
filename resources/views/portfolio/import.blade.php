                                ...
                                <form method="POST" action="{{ route('portfolio.import.json-resume') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="url"
                                            ...
                                            id="json_resume_url" name="json_resume_url"
                                            placeholder="https://ejemplo.com/resume.json"
                                            value="{{ old('json_resume_url') }}" required>
                                        @error('json_resume_url')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">
                                            Ejemplo:
                                            <code>https://gist.githubusercontent.com/username/id/raw/resume.json</code>
                                        </small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="github_username" name="github_username" placeholder="tu-usuario"
                                                value="{{ old('github_username') }}" required>
